...
{
	auto e = RG2Graphics->GetEffect(ET_ColorMatrix);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_DiscreteTransfer);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_GammaTransfer);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_HueRotation);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_LinearTransfer);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_Saturation);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_TableTransfer);
	e->SetInput(0, input);
...
{
	auto e = RG2Graphics->GetEffect(ET_Morphology);
	e->SetInput(0, input);
